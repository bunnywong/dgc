...
if ( ! class_exists( 'myCRED_Admin' ) ) {
	class myCRED_Admin {
      ...
      $row['adjust'] .= '<a href="user-profile/?user_id='.$user_id.'" target="_blank">- User Profile</a><br>';
      $row['adjust'] .= '<a href="/wp-admin/admin.php?ref=manual&paged=1&s&page=myCRED&user='.$user_id.'" target="">- User Log (back-end)</a>';
